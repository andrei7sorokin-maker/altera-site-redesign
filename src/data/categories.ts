...
export const categoryCards: Record<Locale, CategoryCard[]> = {
  et: [
    { key: "am", title: "AM", subtitle: "Mopedi juhiload", href: "/am-kategooria-tallinnas/", price: "690 €", lessons: "24h teooria / 12h praktika", age: "Alates 14 a", image: "/images/categories/am/am-honda-vision-navy.png", excerpt: "Mopeed kuni 50 cm³ ja kuni 45 km/h. Kool annab õppe ajaks kaitsevarustuse." },
    { key: "b", title: "B", subtitle: "Sõiduauto juhiload", href: "/b-kategooria-tallinnas/", price: "1090 €", lessons: "29h teooria / 28h praktika", age: "Alates 15,5 a", image: "/images/categories/b/b-toyota-corolla-blue.png", excerpt: "Kõige populaarsem kursus kuni 3500 kg sõidukitele. Õpe Toyota Corolla, Auris ja Verso autodel." },
    ...
    { key: "be", title: "BE", subtitle: "Sõiduauto haagisega", href: "/be-kategooria-tallinnas/", price: "350 €", lessons: "4h teooria / 4h praktika", age: "B-kategooria olemasolu", image: "/images/categories/be/be-ad-wrap-covered.png", excerpt: "B-kategooria auto koos haagisega üle 750 kg. Sobib ka paadihaagise jaoks." },
  ],
  ru: [
    { key: "am", title: "AM", subtitle: "Права на мопед", href: "/ru/am-kategooria-tallinnas/", price: "690 €", lessons: "24ч теория / 12ч практика", age: "С 14 лет", image: "/images/categories/am/am-honda-vision-navy.png", excerpt: "Мопед до 50 см³ и до 45 км/ч. На время обучения школа выдает защитную экипировку." },
    { key: "b", title: "B", subtitle: "Права на легковой автомобиль", href: "/ru/b-kategooria-tallinnas/", price: "1090 €", lessons: "29ч теория / 28ч практика", age: "С 15,5 лет", image: "/images/categories/b/b-toyota-corolla-blue.png", excerpt: "Самый востребованный курс для легкового автомобиля до 3500 кг. Практика проходит на Toyota Auris, Verso, CH-R." },
    ...
    { key: "be", title: "BE", subtitle: "Легковой автомобиль с прицепом", href: "/ru/be-kategooria-tallinnas/", price: "350 €", lessons: "4ч теория / 4ч практика", age: "Нужна категория B", image: "/images/categories/be/be-ad-wrap-covered.png", excerpt: "Для автомобиля B категории с прицепом полной массой более 3,5 т. Подходит для перевозки катера, яхты, лошадей." },
  ],
  en: [
    { key: "am", title: "AM", subtitle: "Moped licence", href: "/en/am-kategooria-tallinnas/", price: "690 €", lessons: "24h theory / 12h practice", age: "From 14 years", image: "/images/categories/am/am-honda-vision-navy.png", excerpt: "Moped up to 50 cm³ and up to 45 km/h. Protective gear is provided during training." },
    { key: "b", title: "B", subtitle: "Passenger car licence", href: "/en/b-kategooria-tallinnas/", price: "1090 €", lessons: "29h theory / 28h practice", age: "From 15.5 years", image: "/images/categories/b/b-toyota-corolla-blue.png", excerpt: "The most popular course for passenger cars up to 3500 kg. Training uses Toyota Corolla, Auris and Verso vehicles." },
    ...
    { key: "be", title: "BE", subtitle: "Car with trailer", href: "/en/be-kategooria-tallinnas/", price: "350 €", lessons: "4h theory / 4h practice", age: "B licence required", image: "/images/categories/be/be-ad-wrap-covered.png", excerpt: "For B-category cars with a trailer over 750 kg, including boat trailers." },
  ],
};
