...
export const categoryCards: Record<Locale, CategoryCard[]> = {
  ...
  ru: [
    { key: "am", title: "AM", subtitle: "Права на мопед", href: "/ru/am-kategooria-tallinnas/", price: "690 €", lessons: "24ч теория / 12ч практика", age: "С 14 лет", image: "/images/categories/am/am.png", excerpt: "Мопед до 50 см³ и до 45 км/ч. На время обучения школа выдает защитную экипировку." },
    { key: "a", title: "A", subtitle: "Права на мотоцикл", href: "/ru/a-kategooria-tallinnas/", price: "590 €", lessons: "10ч теория / 10ч практика", age: "С 24 лет", image: "/images/categories/a/a.png", excerpt: "Мотоциклы мощнее 35 кВт. Для регистрации нужна действующая лицензия любой категории." },
    { key: "b", title: "B", subtitle: "Права на легковой автомобиль", href: "/ru/b-kategooria-tallinnas/", price: "910 €", lessons: "29ч теория / 28ч практика", age: "С 15,5 лет", image: "/images/categories/b/b.png", excerpt: "Самый востребованный курс для легкового автомобиля до 3500 кг. Практика проходит на Toyota Corolla, Auris и Verso." },
  ...
  en: [
    { key: "am", title: "AM", subtitle: "Moped licence", href: "/en/am-kategooria-tallinnas/", price: "690 €", lessons: "24h theory / 12h practice", age: "From 14 years", image: "/images/categories/am/am.png", excerpt: "Moped up to 50 cm³ and up to 45 km/h. Protective gear is provided during training." },
    { key: "a", title: "A", subtitle: "Motorcycle licence", href: "/en/a-kategooria-tallinnas/", price: "590 €", lessons: "10h theory / 10h practice", age: "From 24 years", image: "/images/categories/a/a.png", excerpt: "Motorcycles over 35 kW. A valid driving licence in any category is required." },
    { key: "b", title: "B", subtitle: "Passenger car licence", href: "/en/b-kategooria-tallinnas/", price: "910 €", lessons: "29h theory / 28h practice", age: "From 15.5 years", image: "/images/categories/b/b.png", excerpt: "The most popular course for passenger cars up to 3500 kg. Training uses Toyota Corolla, Auris and Verso vehicles." },
