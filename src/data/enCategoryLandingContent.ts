export const enCategoryLandingContent = {
  a: {
    seoTitle: "Category A course in Tallinn | Altera Autokool",
    seoDescription: "Category A motorcycle training in Tallinn. Course content, requirements, prices and registration at Altera Autokool.",
    eyebrow: "Category A",
    ...
    midSections: [
      { eyebrow: "Practice and equipment", title: "Training is focused on control and safety", text: "The practical part helps you work on motorcycle control, manoeuvres, slow-speed riding, braking and road behaviour. The goal is not just to pass the exam, but to ride with more confidence in real traffic." },
      { eyebrow: "Who it is for", title: "A strong fit for drivers moving to the next level", text: "Category A training is a good choice for drivers who want to expand their options and gain the right to ride a more powerful motorcycle. The course is designed so that confidence can be built gradually." }
    ],
    priceSection: { eyebrow: "Prices", title: "Key information before registration", text: "Before you begin, it helps to understand the basic course price, the practical lesson volume and the main requirements. We have gathered the key points in one block.", cards: [{ eyebrow: "Category A", title: "Course", price: "590 €", text: "10 hours of theory and 10 hours of practice." }, { eyebrow: "Gear", title: "Protection", price: "Included", text: "The school provides protective gear during training." }, { eyebrow: "Licence", title: "Requirement", price: "Required", text: "A valid driving licence is needed for registration." }, { eyebrow: "Payment", title: "Options", price: "Ask us", text: "A suitable payment option can be discussed during registration." }] },
    faqItems: [
      { question: "Can I join without an existing licence?", answer: "No, Category A registration requires a valid driving licence in any category." },
      ...
      { question: "How long is the Category A course?", answer: "The course includes 10 hours of theory and 10 hours of practice. The exact calendar duration depends on lesson scheduling." },
      { question: "Can practical lessons be planned flexibly?", answer: "Yes, practical lesson times are arranged based on the student’s possibilities and pace." }
    ],
  ...
  am: {
    ...
    midSections: [
      { eyebrow: "Age and conditions", title: "What to know before registering", text: "The minimum age for obtaining the licence is 14. Registration requires parental permission, a valid medical certificate and a digital photo." },
      { eyebrow: "Study structure", title: "A clear plan helps build confidence", text: "For Category AM, it is important that a young student understands both the traffic rules and their own responsibility on the road. That is why the course is structured step by step." }
    ],
    priceSection: { eyebrow: "Price", title: "Main information before you begin", text: "Before registering, it is useful to understand the course scope, required documents and what is included in the price.", cards: [{ eyebrow: "Category AM", title: "Course", price: "690 €", text: "24 hours of theory and 12 hours of practice." }, { eyebrow: "Gear", title: "Protection", price: "Included", text: "The school provides the necessary protective gear." }, { eyebrow: "Age", title: "Minimum", price: "14 years", text: "The minimum age for obtaining the licence is 14." }, { eyebrow: "Documents", title: "Registration", price: "Prepare in advance", text: "Parental permission, a medical certificate and a digital photo are required." }] },
    faqItems: [
      { question: "From what age can I join the AM course?", answer: "The minimum age for obtaining a Category AM licence is 14." },
      { question: "Does the school provide protective gear?", answer: "Yes, the school provides the necessary protective gear during training." },
      { question: "Which documents are required?", answer: "Parental permission, a valid medical certificate and a digital photo are required." },
      { question: "Is the course suitable for a complete beginner?", answer: "Yes, the course is designed for a young rider who is starting road use for the first time." }
    ],
    cta: { eyebrow: "CTA", title: "Would you like to start a Category AM course in Tallinn?", text: "Send a request or contact us if you want to confirm the next course start, conditions or registration. We will help you through the process clearly.", primary: "Register now", secondary: "Call +372 511 47 40" }
  },
  be: {
    seoTitle: "Category BE course in Tallinn | Altera Autokool",
    seoDescription: "Category BE training in Tallinn. Practical learning, clear conditions and quick registration at Altera Autokool.",
    eyebrow: "Category BE",
    title: "Category BE course in Tallinn",
    description: "Category BE training is suitable for drivers who need the correct licence for driving with a trailer and practical preparation for doing it confidently. At Altera, the course follows a clear process and is easy to join.",
    imageSrc: "/images/categories/be/be-ad-wrap-covered.png",
    imageAlt: "Category BE course in Tallinn",
    ...
    midSections: [
      { eyebrow: "Student requirements", title: "A valid Category B licence is required", text: "To register for Category BE, you need a valid Category B driving licence. Additional formal requirements can be confirmed during registration if needed." },
      { eyebrow: "Practical preparation", title: "The focus is on control and safe manoeuvring", text: "The practical lessons help you work on towing control, reversing, turning, parking and typical road situations that most often create uncertainty." }
    ],
    priceSection: { eyebrow: "Price", title: "Quick overview before the course starts", text: "The Category BE course is short and practical, so it is useful to see the main scope, requirements and core conditions at a glance.", cards: [{ eyebrow: "Category BE", title: "Course", price: "350 €", text: "4 hours of theory and 4 hours of practice." }, { eyebrow: "Requirement", title: "Category B", price: "Required", text: "A valid Category B licence is required for registration." }, { eyebrow: "Use case", title: "Trailer", price: "Over 750 kg", text: "Also suitable for boat trailers and heavier trailer combinations." }, { eyebrow: "Payment", title: "Options", price: "Ask us", text: "A suitable payment option can be discussed during registration." }] },
    faqItems: [
      { question: "Is the course suitable for boat trailer use?", answer: "Yes, the course is also suitable for boat trailer use when the vehicle-trailer combination requires Category BE." },
      { question: "Do I need an existing Category B licence?", answer: "Yes, registration for the Category BE course requires a valid Category B licence." },
      { question: "How long is the course?", answer: "The course includes 4 hours of theory and 4 hours of practice." },
      { question: "Does the course focus on real practical situations?", answer: "Yes, a strong part of the training is focused on manoeuvring, safety and exam-relevant preparation." }
    ],
    cta: { eyebrow: "CTA", title: "Would you like to start a Category BE course in Tallinn?", text: "Contact us or send a request. We can help you confirm the conditions, the timing and the next practical steps.", primary: "Register now", secondary: "Call +372 511 47 40" }
  },
  esmaabi: {
    seoTitle: "First aid course in Tallinn | Altera Autokool",
    seoDescription: "First aid course in Tallinn for drivers and students. Timing, content and registration in one place.",
    eyebrow: "First aid",
    title: "First aid course in Tallinn",
    description: "The first aid course is suitable for drivers and students who want a practical and understandable foundation in how to act in an emergency. At Altera, you get the core knowledge together with a simple registration path.",
    imageSrc: "/images/hero/altera-hero.png",
    imageAlt: "First aid course in Tallinn",
    ...
    topSections: [
      ...
      { eyebrow: "Course topics", title: "Main situations and responses", list: ["First aid basics and calling for help", "Assessing the condition of the injured person", "Responding to unconsciousness", "Bleeding, trauma and burns", "First actions in a road accident"] }
    ],
    midSections: [
      { eyebrow: "Format", title: "The course is built with a practical mindset", text: "The course takes place in a classroom setting and focuses on the actions that are most important to know in real situations. The exact timing and format are confirmed during registration." },
      { eyebrow: "Why it matters", title: "First aid knowledge creates more confidence", text: "Both on the road and in everyday life, situations may happen where a calm and quick response can help avoid more serious consequences. That makes first aid useful as a real skill, not just a formal requirement." }
    ],
    priceSection: { eyebrow: "Price", title: "Information before registration", text: "As course timing and format may depend on the group, the best approach is to confirm the price and next available date directly with us.", cards: [{ eyebrow: "First aid", title: "Course", price: "Ask us", text: "The price is confirmed during registration." }, { eyebrow: "Timing", title: "Schedule", price: "Tallinn", text: "Course timing and format depend on the group schedule." }, { eyebrow: "Content", title: "Practical focus", price: "Core topics", text: "The course focuses on essential actions and the right basic techniques." }, { eyebrow: "Registration", title: "Quick contact", price: "Web / phone", text: "Send a request and we will tell you about the next available option." }] },
    faqItems: [
      { question: "Who is the first aid course suitable for?", answer: "It is suitable for drivers, students and anyone who wants to refresh or gain basic first aid knowledge." },
      { question: "Does it include road accident situations?", answer: "Yes, one of the covered topics is how to act in a road accident situation." },
      { question: "Is the exact price shown on the page?", answer: "The course price is confirmed during registration or direct contact with us." },
      { question: "How do I register for the first aid course?", answer: "You can register through the website, by phone or by email." }
    ],
    cta: { eyebrow: "CTA", title: "Would you like to join a first aid course in Tallinn?", text: "Contact us to ask about the next course, the timing and registration details. We will help you choose the right option.", primary: "Register now", secondary: "Call +372 511 47 40" }
  }
} as const;
